...
CATEGORY_TAGS = {
    ...
    "museum": {"architecture", "art", "culture", "history", "sightseeing"},
    "gallery": {"art", "culture", "photography"},
    "viewpoint": {"nature", "night_view", "photography", "sightseeing", "views"},
    "artwork": {"art", "culture", "photography", "sightseeing"},
    "theme_park": {"activity", "family", "theme_parks"},
    "zoo": {"activity", "animals", "family", "nature"},
    "aquarium": {"activity", "animals", "family", "nature", "water"},
    "historic": {"architecture", "culture", "history", "photography", "sightseeing"},
    "place_of_worship": {"architecture", "culture", "history", "photography", "religious_sites"},
    "marketplace": {"markets", "local_street_food", "culture"},
    "theatre": {"activity", "culture", "night_view", "performing_arts"},
    "arts_centre": {"activity", "art", "culture", "performing_arts"},
    "park": {"chill", "nature", "parks_gardens", "photography", "rewarding_walks"},
    "garden": {"chill", "nature", "parks_gardens", "photography", "rewarding_walks"},
    "nature_reserve": {"animals", "nature", "parks_gardens", "photography", "rewarding_walks"},
    "water_park": {"activity", "family", "theme_parks", "water"},
    "sports_centre": {"activity"},
    "spa": {"chill", "wellness"},
    "beach": {"chill", "nature", "photography", "water"},
    "peak": {"nature", "photography", "rewarding_walks", "sightseeing", "views"},
    "mall": {"chill", "malls", "shopping"},
    "department_store": {"malls", "shopping"},
    "tower": {"architecture", "night_view", "photography", "sightseeing", "views"},
