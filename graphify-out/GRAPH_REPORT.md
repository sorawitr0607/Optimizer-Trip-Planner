...
3. `PlannerRefusal` - 66 edges
4. `ProviderUnavailable` - 54 edges
5. `optimize_trip()` - 40 edges
6. `FakeRouteProvider` - 39 edges
7. `copy()` - 38 edges
8. `ProviderBudgetExceeded` - 37 edges
9. `FakePlaceProvider` - 36 edges
10. `freeze_snapshot()` - 29 edges
